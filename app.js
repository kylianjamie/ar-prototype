...
class App{
	constructor(){
        ...
        this.reticle = new THREE.Mesh(
            new THREE.PlaneBufferGeometry( 0.75, 0.75 ).rotateX( - Math.PI / 2 ),
            new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load('/img/reticle-texture.png'), transparent: true })
        );
